...
public class ResultsPanel extends JScrollPane {
    ...
    public ResultsPanel() {//顯示搜尋圖片結果的panel
        contentPanel = new JPanel(new GridLayout(0, 3, 10, 10));//將row由2改成0
        contentPanel.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));
        contentPanel.setBackground(Color.WHITE);

        setViewportView(contentPanel);
        setBorder(BorderFactory.createEmptyBorder());
        JScrollBar rightScrollBar = getVerticalScrollBar();
        rightScrollBar.setUnitIncrement(25);//設定右方scrollbar的靈敏度
    }
